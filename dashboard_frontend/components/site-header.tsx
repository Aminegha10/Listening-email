        ...
        <div className="flex items-center space-x-4">
            ...
            <DropdownMenuContent align="end" className="w-80 p-2 shadow-xl">
              <div className="px-3 py-2 border-b border-gray-100 dark:border-gray-700 mb-2">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary" className="bg-teal-100 text-teal-700 dark:bg-teal-950 dark:text-teal-300">
                    3 new
                  </Badge>
                </div>
              </div>
              ...
              <DropdownMenuItem className="p-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md cursor-pointer">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-sm text-gray-900 dark:text-white">User registration</p>
              ...
              <DropdownMenuItem className="p-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md cursor-pointer">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-sm text-gray-900 dark:text-white">System maintenance</p>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 p-2 shadow-xl">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="rounded-md cursor-pointer text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors duration-150">
                <span>Sign out</span>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
