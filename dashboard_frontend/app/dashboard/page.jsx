...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-2 gap-3 md:gap-4">
      ...
      {/* Bottom Grid Section */}
      <div className="grid grid-cols-1 xl:grid-cols-[5fr_4fr] 2xl:grid-cols-[5fr_4fr] gap-4">
